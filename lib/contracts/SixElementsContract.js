...
class SixElementContract extends Contract_1.default {
    ...
    async buyEnergy(energy) {
        ...
        await (contract === null || contract === void 0 ? void 0 : contract.buyEnergy({ value: this.ENERGY_PRICE.mul(energy) }));
    }
    async createArmy(x, y, kind, unitCount) {
        ...
        if (address !== undefined) {
            ...
            const contract = await this.loadWalletContract();
            await (contract === null || contract === void 0 ? void 0 : contract.createArmy(x, y, kind, unitCount, { value: this.ENERGY_PRICE.mul(energy) }));
        }
    }
    async appendUnits(x, y, unitCount) {
        ...
        if (address !== undefined) {
            ...
            const energy = energyNeed.gt(playerEnergy) ? energyNeed.sub(playerEnergy) : 0;
            const contract = await this.loadWalletContract();
            await (contract === null || contract === void 0 ? void 0 : contract.appendUnits(x, y, unitCount, { value: this.ENERGY_PRICE.mul(energy) }));
        }
    }
