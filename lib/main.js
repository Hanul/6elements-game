...
(async () => {
    ...
    skynode_1.el(".game-container", skynode_1.el("h1", "Defantasy"), new SeasonPanel_1.default(), skynode_1.el("p.game-description", "This is defantasy game."), skynode_1.el(".game-board-container", new GameBoard_1.default()), skynode_1.el(".button-container", skynode_1.el("a.button", "Buy Energy", {
